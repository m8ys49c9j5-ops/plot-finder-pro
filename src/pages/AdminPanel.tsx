...
const icons = {
  ...
  settings: () =>
    React.createElement(I, { d: "M12 20a8 8 0 1 0 0-16 8 8 0 0 0 0 16zm0-6a2 2 0 1 0 0-4 2 2 0 0 0 0 4z", size: 18 }),
  ...
  logout: () =>
    React.createElement(I, { d: "M9 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h4M16 17l5-5-5-5M21 12H9", size: 15 }),
  link: () =>
    React.createElement(I, {
  ...
  eye: () =>
    React.createElement(I, {
      d: "M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8zM12 12m-3 0a3 3 0 1 0 6 0 3 3 0 0 0-6 0",
      size: 14,
    }),
  warning: () =>
    React.createElement(I, {
...
async function dbSet(key: string, value: any) {
  ...
  const { error, count } = await supabase.from("app_config").upsert({ key, value }, { onConflict: "key" }).select();
...
function EditText({
  ...
  const input = multiline
    ? React.createElement("textarea", {
        ...
        rows: 2,
        style: { ...base, display: "block", width: "100%", boxSizing: "border-box" },
      })
  ...
  return React.createElement(
    "div",
    { style: { display: "flex", gap: 8, alignItems: multiline ? "flex-start" : "center" } },
    input,
    React.createElement(
      "button",
      {
  ...
  return React.createElement(
    ...
    React.createElement(
      ...
      React.createElement(
        ...
        React.createElement(
          "h3",
          { style: { fontWeight: 700, fontSize: "0.95rem", color: "hsl(var(--foreground))", margin: 0 } },
          title,
        ),
        subtitle &&
          React.createElement(
            "p",
            { style: { fontSize: "0.78rem", color: "hsl(var(--muted-foreground))", margin: "2px 0 0" } },
            subtitle,
          ),
      ),
      action,
  ...
  return React.createElement(
    "div",
    {
      style: {
        ...
        justifyContent: "space-between",
        gap: 16,
        paddingBottom: separator ? "0.9rem" : 0,
        marginBottom: separator ? "0.9rem" : 0,
    ...
    React.createElement(
      ...
      React.createElement(
        "p",
        { style: { fontWeight: 600, fontSize: "0.875rem", color: "hsl(var(--foreground))", margin: 0 } },
        label,
      ),
      sublabel &&
        React.createElement(
          "p",
          { style: { fontSize: "0.75rem", color: "hsl(var(--muted-foreground))", margin: "2px 0 0", lineHeight: 1.5 } },
          sublabel,
        ),
    ),
...
function LockTile({
  ...
  return React.createElement(
    ...
    React.createElement(
      "p",
      { style: { fontWeight: 700, fontSize: "0.875rem", color: "hsl(var(--foreground))", margin: 0, lineHeight: 1.3 } },
      label,
    ),
    React.createElement(
      "p",
      { style: { fontSize: "0.72rem", color: "hsl(var(--muted-foreground))", margin: 0, lineHeight: 1.4 } },
      sublabel,
    ),
    // Toggle
    React.createElement(
    ...
    saving &&
      React.createElement(
        ...
        React.createElement(
          "span",
          { style: { fontSize: "0.75rem", fontWeight: 600, color: "hsl(var(--primary))" } },
          "Saving…",
        ),
      ),
  );
...
const FLOW_ARROWS = [
  ...
  { from: "landing", to: "login", label: "Sign in button" },
  { from: "map", to: "report", label: "Click parcel" },
  { from: "map", to: "login", label: "Sign in button" },
...
const CONTENT_GROUPS = [
  ...
  },
  {
    label: "Pricing & CTA",
    keys: [
      "content_report_section_title",
      "content_pricing_title",
      "content_pricing_subtitle",
      "content_cta_title",
      "content_cta_subtitle",
    ],
  },
  {
    label: "Report & Search",
    keys: [
      ...
      "content_report_unlock_title",
      "content_app_name",
      "content_footer_attribution",
    ],
  },
  {
...
const FEATURE_GROUPS = [
  {
    ...
    items: [
      ...
      { key: "feature_report_page", label: "Report Page", desc: "Enable parcel report after unlocking" },
      {
        ...
        label: "⚠️ Maintenance Mode",
        desc: "Block all non-admin users with a maintenance screen",
        danger: true,
      },
    ],
  },
  {
    ...
    items: [
      {
        key: "feature_cadastral_search",
        label: "Search by Cadastral Number",
        desc: "Allow text search in the search bar",
      },
      {
        key: "feature_map_identify",
        label: "Map Click Identification",
        desc: "Click anywhere on map to identify a parcel",
      },
      { key: "feature_ortho_layer", label: "Satellite Layer Toggle", desc: "Show satellite/ortho view toggle on map" },
      {
        key: "feature_map_attribution",
        label: "Map Attribution",
        desc: 'Show "Geoportal.lt · RC Kadastras" watermark',
      },
    ],
  },
  {
    ...
    items: [
      {
        key: "feature_pricing_modal",
        label: "Pricing / Credits Modal",
        desc: "Show the credit purchase modal when clicking credits",
      },
      {
        key: "feature_sample_report",
        label: "Blurred Sample Report",
        desc: "Show sample report preview below unlock CTA",
      },
    ],
  },
  {
...
export default function AdminPanel() {
  ...
  useEffect(() => {
    setPricingLocal(config.pricing);
  }, [config.pricing]);
  useEffect(() => {
    setSectionOrder(config.report_sections_order);
  }, [config.report_sections_order]);
  useEffect(() => {
    setThemeLocal({
      theme_primary_hsl: config.theme_primary_hsl,
      theme_primary_fg: config.theme_primary_fg,
    ...
    config.theme_primary_hsl,
    config.theme_primary_fg,
    config.theme_background_hsl,
    config.theme_card_hsl,
    config.theme_muted_hsl,
    config.theme_border_hsl,
    config.theme_foreground_hsl,
  ]);
  useEffect(() => {
    setMapLocal({
      map_default_lat: config.map_default_lat,
  ...
  const toggleBool = useCallback(
    (key: string, cur: boolean, label: string) => {
      save(key, !cur, label);
    },
    [save],
  );
  ...
  if (!user || !isAdmin)
    return React.createElement(
      ...
      React.createElement(
        ...
        React.createElement(
          "p",
          { style: { color: "hsl(var(--muted-foreground))", fontSize: "0.875rem", marginBottom: 20 } },
  ...
  const renderDashboard = () => [
    ...
    React.createElement(
      ...
      React.createElement(
        ...
        React.createElement(
          "div",
          { className: "font-display", style: { fontSize: "2rem", fontWeight: 800, color: "hsl(38 80% 40%)" } },
          lockedCount,
        ),
        React.createElement(
          "p",
          { style: { fontSize: "0.75rem", color: "hsl(var(--muted-foreground))", margin: "4px 0 0" } },
          `${freeCount} fields free`,
        ),
      ),
      // Active features
      React.createElement(
        ...
        React.createElement(
          ...
          React.createElement(
            ...
            React.createElement(icons.features, {}),
          ),
          React.createElement("span", { style: { fontWeight: 600, fontSize: "0.85rem" } }, "Active Features"),
        ),
        React.createElement(
          "div",
          { className: "font-display", style: { fontSize: "2rem", fontWeight: 800, color: "hsl(var(--primary))" } },
          featEnabled,
        ),
        React.createElement(
          "p",
          { style: { fontSize: "0.75rem", color: "hsl(var(--muted-foreground))", margin: "4px 0 0" } },
          `of ${FEATURE_GROUPS.flatMap((g) => g.items).length} total`,
        ),
      ),
      // Maintenance
      React.createElement(
        ...
        React.createElement(
          ...
          React.createElement(Toggle, {
            checked: maintOn,
            onChange: (v) => toggleBool("maintenance_mode", !v, "Maintenance Mode"),
            disabled: saving === "maintenance_mode",
          }),
        ),
        React.createElement(Badge, {
          color: maintOn ? "red" : "green",
          label: maintOn ? "ON — Users blocked" : "Off — App live",
        }),
        React.createElement(
          "p",
          { style: { fontSize: "0.72rem", color: "hsl(var(--muted-foreground))", margin: "8px 0 0", lineHeight: 1.5 } },
    ...
    React.createElement(
      Section,
      { key: "quick", title: "Quick Toggles", subtitle: "Most commonly changed settings" },
      React.createElement(
        "div",
        {
      ...
      React.createElement(
        ...
        FLOW_ARROWS.map(({ from, to, label }) => {
          ...
          return React.createElement(
            ...
            React.createElement(
              "span",
              { style: { color: "hsl(var(--primary))", fontSize: "0.8rem", margin: "0 2px" } },
              "→",
            ),
            ...
            React.createElement(
              "span",
              { style: { fontSize: "0.72rem", color: "hsl(var(--muted-foreground))", marginLeft: 4 } },
              `(${label})`,
            ),
          );
        }),
      ...
      React.createElement(
        ...
        PAGE_DEFS.map((p) => {
          ...
          return React.createElement(
            ...
            React.createElement(
              "p",
              { style: { fontSize: "0.78rem", color: "hsl(var(--muted-foreground))", margin: "0 0 12px" } },
              p.desc,
            ),
            React.createElement(
              "div",
        ...
        group.keys.map((key, i) => {
          ...
          return React.createElement(
            ...
            React.createElement(
              ...
              React.createElement(
                "span",
                { style: { fontSize: "0.72rem", color: "hsl(var(--muted-foreground))", fontWeight: 600 } },
                "On",
              ),
              React.createElement(Toggle, {
                checked: btn.enabled,
    ...
    React.createElement(
      ...
      React.createElement(
        ...
        React.createElement(
          ...
          React.createElement(
            "div",
            { style: { fontSize: "1.5rem", fontWeight: 800, color: "hsl(142 76% 30%)" } },
            freeCount,
          ),
          React.createElement(
            "div",
            { style: { fontSize: "0.8rem", color: "hsl(142 76% 30%)" } },
            "Free fields — visible to everyone",
          ),
        ),
      ),
      React.createElement(
        ...
        React.createElement(
          ...
          React.createElement(
            "div",
            { style: { fontSize: "1.5rem", fontWeight: 800, color: "hsl(38 80% 35%)" } },
            lockedCount,
          ),
          React.createElement(
            "div",
            { style: { fontSize: "0.8rem", color: "hsl(38 80% 35%)" } },
            "Paid fields — require 1 credit",
          ),
        ),
      ),
    ),
      ...
      React.createElement(
        ...
        React.createElement(
          "button",
          {
            ...
            style: {
              border: "1.5px solid hsl(142 76% 36% / 0.5)",
              background: "hsl(142 76% 36% / 0.07)",
              color: "hsl(142 76% 28%)",
              borderRadius: 10,
              padding: "10px 22px",
              fontWeight: 600,
        ...
        React.createElement(
          "button",
          {
            ...
            style: {
              border: "1.5px solid hsl(38 92% 50% / 0.5)",
  ...
  const renderPricing = () => {
    ...
    return [
      React.createElement(
        ...
        tiers.map(([dbKey, idx]) => {
          const tier: PricingTier = pricingLocal[idx] ?? {
            name: "",
            credits: 1,
            price: "",
            perSearch: "",
          ...
          return React.createElement(
            ...
            React.createElement(
              ...
              ...(["credits", "price", "perSearch", "save"] as const).map((field) =>
                React.createElement(
                  "div",
                  { key: field },
                  React.createElement(
                  ...
                  React.createElement("input", {
                    ...
                    onChange: (e: any) =>
                      setField(field, field === "credits" ? Number(e.target.value) : e.target.value),
            ...
            React.createElement(
              "button",
              {
                ...
                style: {
                  width: "100%",
                  border: hasChanges ? "none" : "1px solid hsl(var(--border))",
    ...
    React.createElement(
      ...
      React.createElement(
        ...
        sectionOrder.map((id, i) =>
          React.createElement(
            ...
            React.createElement(
              "span",
              { style: { fontWeight: 700, fontSize: "0.8rem", color: "hsl(var(--muted-foreground))", minWidth: 20 } },
              `${i + 1}.`,
            ),
            React.createElement(
              "span",
              ...
              React.createElement(
                "button",
                {
                  ...
                  style: {
                    ...
                    borderRadius: 5,
                    padding: "3px 7px",
                    cursor: i === sectionOrder.length - 1 ? "default" : "pointer",
                    opacity: i === sectionOrder.length - 1 ? 0.3 : 1,
                    display: "flex",
                  },
                },
      ...
      React.createElement(
        "button",
        {
          ...
          disabled:
            JSON.stringify(sectionOrder) === JSON.stringify(config.report_sections_order) ||
            saving === "report_sections_order",
          className: "premium-gradient",
          style: {
            border: "none",
            color: "#fff",
  ...
  function renderTheme(): React.ReactNode[] {
    const THEME_FIELDS: { key: keyof typeof themeLocal; label: string; hint: string }[] = [
      {
        key: "theme_primary_hsl",
        label: "Primary Color",
        hint: "Main brand color. HSL without wrapper e.g. 160 84% 39%",
      },
    ...
    const saveAllTheme = async () => {
      ...
      try {
        ...
        toast.error(e.message ?? "Error saving theme");
      }
      setSaving(null);
    };

    const themeChanged =
      JSON.stringify(themeLocal) !==
      JSON.stringify({
        theme_primary_hsl: config.theme_primary_hsl,
        theme_primary_fg: config.theme_primary_fg,
        theme_background_hsl: config.theme_background_hsl,
    ...
    return [
      React.createElement(
        Section,
        {
          ...
          subtitle:
            "Enter values as HSL without the hsl() wrapper — e.g. 160 84% 39%. Changes preview live in this tab before saving.",
        },
        React.createElement(
          "div",
          ...
          THEME_FIELDS.map((field) =>
            React.createElement(
              ...
              React.createElement(
                "p",
                { style: { fontSize: "0.72rem", color: "hsl(var(--muted-foreground))", marginBottom: 8 } },
                field.hint,
              ),
              React.createElement(
                "div",
                ...
                React.createElement("div", {
                  style: {
                    ...
                    borderRadius: 8,
                    border: "1px solid hsl(var(--border))",
                    background: `hsl(${themeLocal[field.key]})`,
                    flexShrink: 0,
                  },
                }),
              ),
        ...
        React.createElement(
          "div",
          { style: { marginTop: "1.5rem", display: "flex", gap: 12, alignItems: "center" } },
          React.createElement(
            "button",
            {
      ...
      React.createElement(
        Section,
        {
          ...
          subtitle:
            "All CSS variables are injected into :root — every Tailwind class using text-primary, bg-card etc. updates automatically",
        },
        React.createElement(
          "div",
  ...
  function renderMap(): React.ReactNode[] {
    ...
    const saveAllMap = async () => {
      ...
      try {
        ...
        toast.error(e.message ?? "Error saving map config");
      }
      setSaving(null);
    };
    ...
    return [
      React.createElement(
        ...
        React.createElement(
          ...
          React.createElement(
            ...
            React.createElement(
              "p",
              { style: { fontSize: "0.72rem", color: "hsl(var(--muted-foreground))", marginBottom: 8 } },
              "Decimal degrees. Lithuania: ~54–57°N",
            ),
            React.createElement("input", {
              type: "number",
              step: "0.0001",
          ...
          React.createElement(
            ...
            React.createElement(
              "p",
              { style: { fontSize: "0.72rem", color: "hsl(var(--muted-foreground))", marginBottom: 8 } },
              "Decimal degrees. Lithuania: ~21–27°E",
            ),
            React.createElement("input", {
              type: "number",
              step: "0.0001",
          ...
          React.createElement(
            ...
            React.createElement(
              "label",
              { style: { display: "block", fontWeight: 600, fontSize: "0.85rem", marginBottom: 4 } },
              `Default Zoom: ${mapLocal.map_default_zoom}`,
            ),
            React.createElement(
              "p",
              { style: { fontSize: "0.72rem", color: "hsl(var(--muted-foreground))", marginBottom: 8 } },
              "1 = world · 8 = country · 13 = city · 18 = street",
            ),
            React.createElement("input", {
              type: "range",
              min: "1",
          ...
          React.createElement(
            ...
            React.createElement(
              "p",
              { style: { fontSize: "0.72rem", color: "hsl(var(--muted-foreground))", marginBottom: 8 } },
              "Layer shown when map first loads",
            ),
            React.createElement(
              "div",
                ...
                React.createElement(
                  "button",
                  {
                    ...
                    style: {
                      ...
                      cursor: "pointer",
                      border:
                        mapLocal.map_default_layer === opt
                          ? "2px solid hsl(var(--primary))"
                          : "1px solid hsl(var(--border))",
                      background:
                        mapLocal.map_default_layer === opt ? "hsl(var(--primary) / 0.08)" : "hsl(var(--background))",
        ...
        React.createElement(
          "div",
          { style: { marginTop: "1.5rem", display: "flex", gap: 12, alignItems: "center", flexWrap: "wrap" } },
          React.createElement(
            "button",
            {
              onClick: saveAllMap,
              ...
              style: {
                ...
                padding: "10px 28px",
                fontWeight: 600,
                cursor: mapChanged ? "pointer" : "default",
                fontSize: "0.875rem",
                display: "flex",
                alignItems: "center",
                gap: 7,
  ...
  function renderUsers(): React.ReactNode[] {
    const loadUsers = async () => {
      ...
      try {
        ...
        const allIds = Array.from(
          new Set([...(creditsData?.map((c) => c.user_id) ?? []), ...(rolesData?.map((r) => r.user_id) ?? [])]),
        );
    ...
    if (users.length === 0 && !usersLoading) {
      return [
        React.createElement(
          Section,
          { key: "users-empty", title: "User Management", subtitle: "View users, adjust credits, grant admin access" },
          React.createElement(
            "div",
            ...
            React.createElement(
              "p",
              { style: { marginTop: 10, fontSize: "0.78rem", color: "hsl(var(--muted-foreground))" } },
                      ...
                      React.createElement(
                        ...
                        React.createElement(
                          ...
                          React.createElement("input", {
                            ...
                            onChange: (e: any) =>
                              setCreditEdits((prev) => ({ ...prev, [u.id]: parseInt(e.target.value, 10) || 0 })),
                            style: {
                              width: 72,
                              border: "1px solid hsl(var(--border))",
                              borderRadius: 7,
    ...
    React.createElement(
      ...
      React.createElement(
        ...
        React.createElement(
          ...
          React.createElement(
            "span",
            { className: "font-display font-bold text-foreground", style: { fontSize: "1rem" } },
            "Žemė",
